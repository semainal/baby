  ...
  return (
    <div className="sidebar">
        <div className="sidebarItem">
          ...
          <p className="sidebarDesc">Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
        ...
        <ul className="sidebarList">
            ...
            <li className="sidebarListItem">Stories</li>
            <li className="sidebarListItem">Meals</li>
            <li className="sidebarListItem">Plays</li>
